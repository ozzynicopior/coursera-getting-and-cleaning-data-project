...
# Search for matches to argument mean or STDEV within each element of character vector
...
## Create independent 'tidy data set' with the average (AVG) of each variable -- for each activity / subject
